# tests/9_integration/test_compilation_checking.py
...
def test_stitch_modules_compiles_in_memory_before_writing() -> None:
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        def mock_verify_compiles_string(
...
def test_stitch_modules_writes_error_file_on_compilation_failure() -> None:
...
def test_stitch_modules_cleans_up_error_files_on_success() -> None:
...
def test_stitch_modules_handles_actual_compilation_failure() -> None:
...
def test_stitch_modules_error_file_has_correct_date_format() -> None:
