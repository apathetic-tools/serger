# tests/50_core/test_post_stitch_processing.py
...
def test_post_stitch_processing_with_valid_file(tmp_path: Path) -> None:
...
def test_post_stitch_processing_with_none_config(tmp_path: Path) -> None:
