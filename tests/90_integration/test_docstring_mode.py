# tests/90_integration/test_docstring_mode.py
...
def test_docstring_mode_keep() -> None:
...
def test_docstring_mode_strip() -> None:
...
def test_docstring_mode_public() -> None:
...
def test_docstring_mode_dict() -> None:
