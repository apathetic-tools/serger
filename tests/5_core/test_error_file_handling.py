# tests/5_core/test_error_file_handling.py
...
def test_write_error_file_creates_file_with_header() -> None:
...
def test_write_error_file_includes_error_details() -> None:
...
def test_write_error_file_uses_date_suffix() -> None:
...
def test_write_error_file_deletes_pre_existing_error_files() -> None:
...
def test_write_error_file_does_not_delete_new_file() -> None:
...
def test_cleanup_error_files_deletes_matching_files() -> None:
...
def test_cleanup_error_files_handles_no_files() -> None:
...
def test_cleanup_error_files_handles_permission_errors() -> None:
