# tests/95_integration_output/test_comments_mode.py
...
def test_comments_mode_keep(tmp_path: Path) -> None:
...
def test_comments_mode_strip(tmp_path: Path) -> None:
...
def test_comments_mode_ignores(tmp_path: Path) -> None:
...
def test_comments_mode_inline(tmp_path: Path) -> None:
